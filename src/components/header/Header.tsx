        ...
        <header className="flex flex-wrap flex-col sm:justify-start sm:flex-nowrap z-50 w-full text-md py-4 bg-white dark:bg-gray-800">
            <nav className=" w-full mx-auto sm:flex sm:items-center sm:justify-between" aria-label="Global">
                ...
                <div className="flex flex-row flex-wrap items-center gap-10 mt-5 sm:justify-end sm:mt-0 sm:pl-5">
                    ...
                    <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" aria-current="page" href="#projects">Projects</a>
                    <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" href="#skillsection">Skills</a>
                    <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" href="#contact">Contact</a>
                    <DarkModeSwitch />
                </div>
            </nav>
        </header>
